...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <link rel="stylesheet" href="{{ asset('css/teaser-style.css') }}">
    <title>Jbeauty</title>
...
<body style="background-image: url(../picture/background.png)">
    <div class="nav-top" style="margin: 0;">
        ...
        <div class="Jbeauty-logo">
            ...
            <h1 style="margin: 1rem auto;">Grand Opening in Autumn 2022</h1>
        </div>
    </div>
    <div class="middle-area-sns">
        <p class="sns-advertise">The latest information is distributed on the official SNS.<br>Follow me!</p>
        <ul class="nav2">
            <!-- <li class="sns2"><a target="_blank" href="https://www.facebook.com/japanbeautyconnect/"><img class="center-img" src="./pic/facebook.png"></a></li> -->
            <li class="sns2"><a target="_blank" href="https://twitter.com/JBEAUTY_Resort"><img class="center-img" src="{{ asset('picture/twitter-b.png') }}"></a></li>
    ...
    <div class="wrapper">
        ...
        <ul class="header-nav">
            <li class="nav-btn"  style="border: none; margin: 2rem auto; padding:0;"><a href="https://forms.gle/K2KwCxfwzHKj2FX19" class="btn-square">Membership Join Free</a></li>
        </ul>
        <div class="Jbeauty-logo">
            <h1>Soft opening underway for grand opening.</h1>
        </div>
        <ul class="header-nav" style="height: fit-content;">
            <li class="nav-btn"  style="border: none; margin: 2rem auto 1rem auto; padding:0;"><a href="{{ asset('pdf/JBR_popup_en_new.pdf') }}" download="JBR_popup_en.pdf" class="btn-square mobile-s">Click here for details</a></li>
        </ul>
        <ul class="header-nav" style="height: fit-content;">
            <li class="nav-btn"  style="border: none; margin: 1rem auto 2rem auto; padding:0;"><a href="{{ asset('pdf/JBR_popup_jp_new.pdf') }}" download="JBR_popup_jp.pdf" class="btn-square">詳細はこちら</a></li>
        </ul>
    ...
    <div class="fwrapper">
          <p class="footer-p" style="color:white" >© 2022 J Beauty .</p>
    </div>
</body>
</html>